...
class ChloeAI:
    ...
    def getNestedFolderData(self, top_folder_path : str, terminal_progress_display_enabled : bool = False) -> None:

        for root,dirs,files in walker(top_folder_path):
            if not "$RECYCLE.BIN" in root:
                self.getFolderData(root.replace('\\','/'),terminal_progress_display_enabled)
    ...
    def getFolderData(self, reference_path : str, terminal_progress_display_enabled : bool = False) -> None:
